...
void EntityObject::Create(GLFWwindow* window)
{
...
void EntityObject::Update(GLFWwindow* window)
{
...
void EntityObject::FixedUpdate(GLFWwindow* window, float fixedDeltaTime) {
    onGround = false;
